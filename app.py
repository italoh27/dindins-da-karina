...
def normalizar_imagem_sabor(img, nome=""):
    ...
    imagens_por_nome = {
        ...
        "maracujá trufado": "/static/card_maracuja_trufado_gourmet_v2.webp",
        "maracuja trufado": "/static/card_maracuja_trufado_gourmet_v2.webp",
        ...
        "maracujá": "/static/card_maracuja_gourmet_v2.webp",
        "maracuja": "/static/card_maracuja_gourmet_v2.webp",
...
def remover_item_carrinho(item_index):
    ...
    if is_ajax_request():
        return jsonify({
            ...
            "flavor_name": removido.get("nome") if removido else "",
